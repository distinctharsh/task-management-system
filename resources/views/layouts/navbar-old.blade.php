<nav class="navbar navbar-expand-lg navbar-light bg-white shadow-sm fixed-top">
  <div class="container">
    <div class="d-flex align-items-center" style="height: 80px;">
      <img src="{{ asset('images/emblem-dark.png') }}" alt="Emblem" class="h-100" style="object-fit: contain; max-width: 60px;">

      <div class="d-flex flex-column ms-3">
        <strong lang="hi" class="bold-font" style="font-size: 1.1rem; line-height: 1.2;">मंत्रिमंडल सचिवालय</strong>
        <span class="bold-font" style="font-size: 1rem;">Cabinet Secretariat</span>
        <!-- <img src="{{ asset('images/nic-main.png') }}" alt="NIC Logo" class="h-100 " style="object-fit: contain; max-width: 120px; height: auto;"> -->
      </div>
